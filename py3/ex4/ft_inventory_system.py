...
def inventory_system() -> None:
    ...
    for i in range(1, len(sys.argv)):
        ...
        try:
            ...
            print(
                "Quantity error for '" + item + "': invalid literal "
                "for int() with base 10: '" + quantity_text + "'"
            )
    ...
    if total_quantity > 0:
        for item in inventory:
            ...
            print("Item", item, "represents", str(round(percentage, 1)) + "%")
        ...
        print(
            "Item most abundant: ", most_item, "with "
            "quantity", inventory[most_item]
        )
        print(
            "Item least abundant: ", least_item, "with "
            "quantity", inventory[least_item]
        )
